...
library(tidyverse)
read.csv("../../students_STAT_720_A.csv") %>% 
...
- [Website](https://stat720.github.io/summer2026)
- Syllabus
- Statistical programming requirements  
- Rough mindmap of the course (on whiteboard)  
- [Semester project - design your own experiment.](https://stat720.github.io/summer2026/notes/semester-project.html)   
...
```{r blueprint, echo=FALSE, fig.cap="Fisher’s diagram ‘The Principles of Field Experimentation’. Figure 1 in [Preece (1990)](https://doi.org/10.2307/2532438).", out.width = '70%'}
...
- Answer [this short survey](https://forms.gle/Cr6Nc3ZThJjqqtM36) to figure out if we need to move 1-1.5 weeks of class to Zoom. 
