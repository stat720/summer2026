# Power and precision analyses II
...
- HW3 is posted. 
- Schedule your project presentations. 

## Review: what is statistical power? 
...
### Approaches to power computations: 

**Analytic** 

- Follow a formula considering $t_{\alpha, \nu}$, $t_{\beta, \nu}$, $se(\hat\theta)$, and $r$. 
- Very straightforward for simple designs where $\nu$ can be easily obtained. 
- More complicated when $\nu$ is approximated (mixed models).

The power of an experiment can be computed obtaining $t_{\beta, \nu}$ and then determining the power as $1-\beta$. Then, the equation for $t_{\beta, \nu}$ is 
...
A lot the concepts we're learning in STAT 720 are based on long-run frequencies, or what would happen *generally speaking*. 
...
- Online -- planning an experiment. VERY important for your projects!
